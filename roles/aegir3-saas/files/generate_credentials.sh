...
API_KEY=`(drush @hostmaster ctev services_endpoint hosting_saas && echo "echo \\$endpoint->authentication['services_api_key_auth']['api_key'];")|sed -r "s/\x1B\[([0-9]{1,2}(;[0-9]{1,2})?)?[mGK]//g"|php -a|sed '3q;d'`
